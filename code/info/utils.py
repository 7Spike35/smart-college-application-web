...
def result1(rank, course_requirement, weights):
    ...
    file_path_subjects = 'D:\py_workspace\smart-college-application-web\code\info\data.csv'
    ...
    file_path_holland = 'D:\py_workspace\smart-college-application-web\code\info\data_subject_holland.csv'
    ...
    file_path_cluster = 'D:\py_workspace\smart-college-application-web\code\info\cluster_results.csv'
